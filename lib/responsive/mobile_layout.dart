              ...
              child: SingleChildScrollView(
                ...
                children: [
                  Container(
                    ...
                    child: Text('My Projects', style: GoogleFonts.poppins(textStyle: TextStyle(color: Colors.grey[100], fontSize: 40))),
                  ),
                  divider,
                  Container(
                    decoration: BoxDecoration(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 12, color: Colors.white)),
                          ),
                          SizedBox(height: 5,),
                          Wrap(
                            spacing: 5,
